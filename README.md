...
Using `OpenCV`, I got frames (256x256) from the most viewed videos of each channel. Ideally, I would've analyzed all the videos for each channel, but just uploading two videos' worth of frames to google drive estimated four hours lol and there is no way I can store the frames of more than 5000 videos on my laptop locally. Also... i kind of figured that it's illegal to download youtube videos... idk. 
